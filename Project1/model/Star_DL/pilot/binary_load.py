...
def binary_load_dataset(csv_loca, TEST_SIZE, VAL_SIZE, RANDOM_STATE):
  ...
  X_val_ad = scaler.transform(X_val_ad)
  X_test_ad = scaler.transform(X_test_ad)
  
  return X_train, X_val, X_test, y_train, y_val, y_test, X_train_ad, X_val_ad, X_test_ad, y_train_ad, y_val_ad, y_test_ad